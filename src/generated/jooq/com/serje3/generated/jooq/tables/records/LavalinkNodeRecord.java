...
public class LavalinkNodeRecord extends UpdatableRecordImpl<LavalinkNodeRecord> implements Record5<Integer, String, String, String, Boolean> {
    ...
    /**
     * Setter for <code>lavalink_node.enabled</code>.
     */
    public LavalinkNodeRecord setEnabled(Boolean value) {
        set(4, value);
        return this;
    }

    /**
     * Getter for <code>lavalink_node.enabled</code>.
     */
    ...
    public Field<Boolean> field5() {
        return LavalinkNode.LAVALINK_NODE.ENABLED;
    }
    ...
    @Override
    public LavalinkNodeRecord value5(Boolean value) {
        setEnabled(value);
        return this;
    }

    @Override
    public LavalinkNodeRecord values(Integer value1, String value2, String value3, String value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LavalinkNodeRecord(Integer id, String url, String password, String region, Boolean enabled) {
        super(LavalinkNode.LAVALINK_NODE);
